...
exports.default = _default;
},{"tslib":"../node_modules/tslib/tslib.es6.js","./polyfills":"../node_modules/smooth-scrollbar/polyfills.js","./scrollbar":"../node_modules/smooth-scrollbar/scrollbar.js","./plugin":"../node_modules/smooth-scrollbar/plugin.js","./style":"../node_modules/smooth-scrollbar/style.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var bodyScrollBar = _smoothScrollbar.default.init(document.body);

bodyScrollBar.track.xAxis.element.remove();

_ScrollTrigger.ScrollTrigger.scrollerProxy(document.body, {
  scrollTop: function scrollTop() {
    var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.05;
...
bodyScrollBar.addListener(_ScrollTrigger.ScrollTrigger.update); // #######################################-- Start --#######################################
...
window.onload = function () {
  ...
  _gsap.gsap.timeline({
    ...
    height: "auto",
    duration: 3
  }, 0).from(".firstName span", {
    y: -100
  }, 0).from(".lastName span", {
    duration: 1,
    opacity: 0,
    rotateX: -90,
    transformOrigin: "bottom",
    ease: _gsap.Expo.Out
  }, 0.3).from(".landing_content p", {
    autoAlpha: 0,
    scale: 0,
...
}).to(".landing_container", {
  clipPath: "ellipse(150vh 0vh at 50% 0vh",
  ease: "none"
}).to(".landing_background", {
  backgroundSize: "150%",
...
if (window.matchMedia("(min-width : 1050px)").matches) {
  _gsap.gsap.from(".presentation h1", {
    scale: 1.5,
    y: 200,
    ease: _gsap.Expo.out,
    scrollTrigger: {
...
_gsap.gsap.timeline({
  ...
  stagger: 0.5,
  onComplete: function onComplete() {
    return tlLearnContent.play(0);
  }
});

var tlLearnContent = _gsap.gsap.timeline({
  paused: true
}).from(".learn_box", {
  y: 200,
  autoAlpha: 0,
  ...
  ease: "back.out(2)",
  duration: 0.5
}).from(".learn_box_title svg circle", {
  strokeDashoffset: 288.56,
  duration: 2,
  stagger: 1.5
}, 0.2).from(".polygon", {
  autoAlpha: 0,
...
_gsap.gsap.set(".card_box_back", {
  rotateY: "180deg"
}); // Animation for the title


_gsap.gsap.from(".parcour_title", {
  scale: 1.5,
  x: 900,
  y: 200,
  ease: _gsap.Expo.out,
...
_gsap.gsap.timeline({
  ...
  stagger: 0.5,
  onComplete: function onComplete() {
    return gsapLigne2.play();
  }
}).from(".ligne3 rect", {
  scale: 0,
  stagger: 0.5,
  onComplete: function onComplete() {
    return gsapLigne4.play();
  },
...
var gsapLigne2 = _gsap.gsap.from(".ligne2 rect", {
  scale: 0,
  transformOrigin: "right",
  stagger: {
    amount: 0.5,
...
var gsapLigne4 = _gsap.gsap.from(".ligne4 rect", {
  scale: 0,
  transformOrigin: "right",
  stagger: {
    amount: 0.5,
...
var code1 = _gsap.gsap.from(".code_html", {
  autoAlpha: 0,
  duration: 1,
  paused: true
});

var code2 = _gsap.gsap.from(".code_css", {
  autoAlpha: 0,
  duration: 1,
  paused: true
});

var code3 = _gsap.gsap.from(".code_js", {
  autoAlpha: 0,
  duration: 1,
  paused: true
});

var code4 = _gsap.gsap.from(".code_react", {
  autoAlpha: 0,
  duration: 1,
  paused: true
});

var code5 = _gsap.gsap.from(".code_firebase", {
  autoAlpha: 0,
  duration: 1,
  paused: true
});

var code6 = _gsap.gsap.from(".code_gsap", {
  autoAlpha: 0,
  duration: 1,
  paused: true
...
function manageCircleLength() {
  var svgCircles = document.querySelectorAll(".card_graphique svg g circle");
  var svgCircles2 = document.querySelectorAll(".card_graphique svg g circle:nth-child(2)");
  var circleDasharray = svgCircles[0].getTotalLength();
  var circleDashoffset1 = circleDasharray - circleDasharray * 0.9;
  var circleDashoffset2 = circleDasharray - circleDasharray * 0.85;
  var circleDashoffset3 = circleDasharray - circleDasharray * 0.6;
  var circleDashoffset4 = circleDasharray - circleDasharray * 0.65;
  var circleDashoffset5 = circleDasharray - circleDasharray * 0.5;
  var circleDashoffset6 = circleDasharray - circleDasharray * 0.3;
  var tabDashoffset = [circleDashoffset1, circleDashoffset2, circleDashoffset3, circleDashoffset4, circleDashoffset5, circleDashoffset6];
  svgCircles.forEach(function (circle) {
    circle.style.strokeDasharray = circleDasharray;
  });

  for (var i = 0; i < svgCircles2.length; i++) {
...
var graph1 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox1", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
  },
  duration: 3
}).from(".card_graphique1 span", {
  autoAlpha: 0,
  scale: 0,
  duration: 1,
  ease: _gsap.Back.easeOut
...
var graph2 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox2", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
...
var graph3 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox3", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
...
var graph4 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox4", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
...
var graph5 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox5", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
...
var graph6 = _gsap.gsap.timeline({
  paused: true
}).from(".circleBox6", {
  strokeDashoffset: function strokeDashoffset(index, target) {
    return target.getTotalLength();
  ...
  duration: 3
}).from(".card_graphique6 span", {
  autoAlpha: 0,
  scale: 0,
  duration: 1,
  ease: _gsap.Back.easeOut
}, 1); //Animation for the Card


var gsapCard1 = _gsap.gsap.from(".card_1", {
  autoAlpha: 0,
  x: -300,
  duration: 1.5,
  paused: true,
  ...
  onReverseComplete: function onReverseComplete() {
    return code1.reverse();
  }
});

var gsapCard2 = _gsap.gsap.from(".card_2", {
  delay: 0.3,
  autoAlpha: 0,
  x: 300,
  duration: 1.5,
  ...
  onReverseComplete: function onReverseComplete() {
    return code2.reverse();
  }
});

var gsapCard4 = _gsap.gsap.from(".card_4", {
  delay: 0.3,
  autoAlpha: 0,
  x: -300,
  duration: 1.5,
  ...
  onReverseComplete: function onReverseComplete() {
    return code4.reverse();
  }
});

var gsapCard5 = _gsap.gsap.from(".card_5", {
  autoAlpha: 0,
  x: 300,
  duration: 1.5,
  paused: true,
  ...
  onReverseComplete: function onReverseComplete() {
    return code5.reverse();
  }
});

_gsap.gsap.from(".card_3", {
  scale: 0,
  onStart: function onStart() {
    return graph3.play();
  },
...
function getBoxPosition(svg, box) {
  var ligne = document.querySelector(svg);
  var ligne_X = ligne.offsetLeft;
  var ligne_Y = ligne.offsetTop;
  var ligne_H = ligne.offsetHeight;
  var card = document.querySelector(box);
  var box_W = card.offsetWidth;
  var box_H = card.offsetHeight;
  return {
    x: ligne_X,
    y: ligne_Y,
    w: box_W,
...
function setBoxPosition() {
  var dataBox1 = getBoxPosition(".svg2", ".card_1");
  var dataBox2 = getBoxPosition(".svg2", ".card_2");
  var dataBox3 = getBoxPosition(".svg3", ".card_3");
  var dataBox4 = getBoxPosition(".svg4", ".card_4");
  var dataBox5 = getBoxPosition(".svg4", ".card_5");
  var dataBox6 = getBoxPosition(".svg5", ".card_6");

  if (window.matchMedia("(max-width : 380px)").matches) {
    console.log("hello");

    _gsap.gsap.set(".card_1", {
      left: dataBox1.x - dataBox1.w / 3,
      top: dataBox1.y - dataBox1.h / 2
    });

    _gsap.gsap.set(".card_2", {
      right: dataBox2.x - dataBox2.w / 3,
      top: dataBox2.y - dataBox2.h / 2
    });

    _gsap.gsap.set(".card_3", {
      left: dataBox3.x - dataBox3.w / 2 + 3.5,
      top: dataBox3.y + dataBox3.lH / 2 - dataBox3.h / 2
    });

    _gsap.gsap.set(".card_4", {
      left: dataBox4.x - dataBox4.w / 3,
      top: dataBox4.y - dataBox4.h / 2
    });

    _gsap.gsap.set(".card_5", {
      right: dataBox5.x - dataBox5.w / 3,
      top: dataBox5.y - dataBox5.h / 2
    });

    _gsap.gsap.set(".card_6", {
      left: dataBox6.x - dataBox6.w / 2 + 3.5,
      top: dataBox6.y + dataBox6.lH
    });
  } else if (window.matchMedia("(max-width : 600px)").matches) {
    console.log("salut");

    _gsap.gsap.set(".card_1", {
      left: dataBox1.x - dataBox1.w / 2,
      top: dataBox1.y - dataBox1.h / 2
    });

    _gsap.gsap.set(".card_2", {
      right: dataBox2.x - dataBox2.w / 2,
      top: dataBox2.y - dataBox2.h / 2
    });
    ...
    _gsap.gsap.set(".card_4", {
      left: dataBox4.x - dataBox4.w / 2,
      top: dataBox4.y - dataBox4.h / 2
    });

    _gsap.gsap.set(".card_5", {
      right: dataBox5.x - dataBox5.w / 2,
      top: dataBox5.y - dataBox5.h / 2
    });
    ...
    _gsap.gsap.set(".card_1", {
      left: dataBox1.x - dataBox1.w,
      top: dataBox1.y - dataBox1.h / 2
    });

    _gsap.gsap.set(".card_2", {
      right: dataBox2.x - dataBox2.w,
      top: dataBox2.y - dataBox2.h / 2
    });
    ...
    _gsap.gsap.set(".card_4", {
      left: dataBox4.x - dataBox4.w,
      top: dataBox4.y - dataBox4.h / 2
    });

    _gsap.gsap.set(".card_5", {
      right: dataBox5.x - dataBox5.w,
      top: dataBox5.y - dataBox5.h / 2
    });
...
setBoxPosition();
window.onresize = setBoxPosition; // Animate rotation on click for the card

var cards = document.querySelectorAll(".card");
cards.forEach(function (card) {
  var cardContent = card.firstElementChild;
  card.addEventListener("click", function () {
    if (card.classList.contains("active")) {
      _gsap.gsap.to(cardContent, {
        rotateY: "360deg",
        duration: 1,
        ease: _gsap.Back.easeIn.config(1)
      });
      ...
      _gsap.gsap.to(cardContent, {
        rotateY: "180deg",
        duration: 2,
        ease: _gsap.Back.easeOut.config(1)
      });
    }
  });
}); // #######################################-- Hobbies --#######################################
...
var contactBox = document.querySelectorAll(".contact_box_title h3");
var contactContent = document.querySelectorAll(".contact_box_content");
contactContent.forEach(function (content) {
  content.style.height = "0px";
});

var animBox = function animBox() {
  contactBox.forEach(function (box, index) {
    if (box.classList.contains("title_inactivate")) {
      box.addEventListener("mouseenter", function () {
        _gsap.gsap.to(".title_triangle".concat(index + 1), {
          scaleX: 4,
          transformOrigin: "top"
        });
      });
  ...
  contactBox.forEach(function (box, index) {
    box.addEventListener("click", function () {
      var height = contactContent[index].style.height;
      ...
      if (height === "0px") {
        ...
        _gsap.gsap.to(".title_stroke".concat(index + 1), {
          scale: 0.5,
          transformOrigin: "left",
          x: "-5rem"
        });
      ...
      for (var i = 0; i < contactContent.length; i++) {
        if (contactContent[i].style.height != 0 && i != index) {
          ...
          _gsap.gsap.to(".title_triangle".concat(i + 1), {
            scale: 1
          });

          _gsap.gsap.to(".title_stroke".concat(i + 1), {
            scale: 1,
            x: 0
          });
        }
...
var logoGit = document.querySelector(".logo_gitHub");
var logoMail = document.querySelector(".logo_email"); // Animate text

_gsap.gsap.set(".contact_txt1 span", {
  y: 200,
  autoAlpha: 0
});

_gsap.gsap.set(".contact_txt2 span", {
  y: 200,
  autoAlpha: 0
});

var hoverTxt1 = _gsap.gsap.to(".contact_txt1 span", {
  autoAlpha: 1,
  y: 0,
  duration: 0.5,
  stagger: 0.1,
...
var hoverTxt2 = _gsap.gsap.to(".contact_txt2 span", {
  autoAlpha: 1,
  y: 0,
  duration: 0.5,
  stagger: 0.1,
...
logoGit.addEventListener("mouseenter", function () {
  return hoverTxt1.play();
});
logoGit.addEventListener("mouseleave", function () {
  return hoverTxt1.reverse();
});
logoMail.addEventListener("mouseenter", function () {
  return hoverTxt2.play();
});
logoMail.addEventListener("mouseleave", function () {
  return hoverTxt2.reverse();
}); //Animate logo

_gsap.gsap.set([logoGit, logoMail], {
  boxShadow: "8px 8px 11px #121111, -8px -8px 11px #484545 "
});

var clickLogo1 = _gsap.gsap.to(logoGit, {
  boxShadow: "inset 8px 8px 11px #121111,inset -8px -8px 11px #484545 ",
  paused: true
});

var clickLogo2 = _gsap.gsap.to(logoMail, {
  boxShadow: "inset 8px 8px 11px #121111,inset -8px -8px 11px #484545 ",
  paused: true
});

logoGit.addEventListener("mousedown", function () {
  return clickLogo1.play();
});
logoGit.addEventListener("mouseup", function () {
  return clickLogo1.reverse();
});
logoMail.addEventListener("mousedown", function () {
  return clickLogo2.play();
});
logoMail.addEventListener("mouseup", function () {
  return clickLogo2.reverse();
});
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js","smooth-scrollbar":"../node_modules/smooth-scrollbar/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
